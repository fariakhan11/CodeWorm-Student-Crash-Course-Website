<%-- 
    ...
    Created on : 9 Feb, 2023, 11:27:44 PM
    Author     : hp
--%>
...
<html>
  ...
  font-size: 16px;
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="pm-course-title col-xs-8 text-center">
                                    <span class="pm-earned-text block cursive">while completing the training course</span>
                                </div>
                                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="pm-course-title underline col-xs-8 text-center">
                                    <span class="pm-credits-text block bold sans">Programming Languages</span>
                                </div>
                                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="pm-certificate-footer">
                                <div class="col-xs-4 pm-certified col-xs-4 text-center">
                                    <span class="pm-credits-text block sans">CodeWithFaria</span>
    ...
    <center>
        <button class="button" onclick="getDownload()" id="mybtn">Download</button>
